...
@section('back-url')
    <div class="col-xs-6"><a href="{{ action('Collection\NewCollectionController@index') }}" class="btn btn-danger btn-xs heading-btn"><i class="icon-arrow-left16 position-left"></i> Go Back</a></div>
@endsection
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-8 col-md-offset-4 mt-20">
                                                                    <form action="{{action('Collection\NewCollectionController@payment')}}" method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <input type="hidden" name="backUrl" value="collection/payment/details/{{$table->customerID}}">
