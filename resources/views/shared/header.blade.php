<div class="navbar navbar-default navbar-fixed-top header-highlight">
    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
        <ul class="nav navbar-nav">
            <li><a class="sidebar-control sidebar-main-toggle hidden-xs" id="sidebarToggle" data-url="{{ action('CommonController@saveState') }}"><i class="icon-paragraph-justify3"></i></a></li>
