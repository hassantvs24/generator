...
@section('content')
    ...
    <div class="bg-white border-radius p-5">
        <div class="row hidden-print">
            <div class="col-xs-6 mt-10"><h6 class="m-5"><i class="icon-printer"></i>  Banking Reports</h6></div>
        ...
        <div class="row">
            <div class="col-xs-12"><h5 class="text-center no-margin">Banking Reports for {{$bank->name}}</h5></div>
        </div>
        <div class="row">
            <div class="col-xs-8"><b class="no-margin">Date: </b>{{$date_rang}} | <b class="no-margin">A/C: </b> {{ac_type($bank->accountNo)}}</div>
