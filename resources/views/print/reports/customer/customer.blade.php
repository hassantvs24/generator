...
@section('content')
    ...
    <div class="bg-white border-radius p-5">
        <div class="row hidden-print">
            <div class="col-xs-6 mt-10"><h6 class="m-5"><i class="icon-printer"></i> Complain Reports</h6></div>
        ...
        <div class="row">
            <div class="col-xs-12"><h5 class="text-center no-margin">Complain Reports</h5></div>
        </div>
        <div class="row">
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    @foreach($table as $row)
                        ...
                        <tr>
                            ...
                            <td class="p-5 pt-0 pb-0">{{$row->customers['name']}} [{{$row->customers['contact']}}]</td>
