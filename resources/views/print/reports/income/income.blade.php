...
@section('content')
    ...
    <div class="bg-white border-radius p-5">
        <div class="row hidden-print">
            <div class="col-xs-6 mt-10"><h6 class="m-5"><i class="icon-printer"></i> Income Reports</h6></div>
        ...
        <div class="row">
            <div class="col-xs-12"><h5 class="text-center no-margin">Income Reports</h5></div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-12">
                <table class="table table-bordered table-condensed">
                    ...
                    <tr>
                        ...
                        <th class="p-5 pt-0 pb-0 ">Income Category</th>
                    ...
                    @foreach($table as $row)
                        ...
                        <tr>
                            ...
                            <td class="p-5 pt-0 pb-0 ">{{$row->category['name']}}</td>
