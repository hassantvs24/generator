...
@section('content')
    ...
    <div class="bg-white border-radius p-5">
        ...
        <div class="row">
            <div class="col-xs-12"><h5 class="text-center no-margin">Profit & Lose Reports for {{$months}}</h5></div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-12">
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody class="text-size-mini">
                        <tr>
                            <td class="p-5 pt-0 pb-0">Total Bill Collection</td>
                            <td class="p-5 pt-0 pb-0 text-right">{{money($bill_collection)}}</td>
                            <td class="p-5 pt-0 pb-0"></td>
                            <td class="p-5 pt-0 pb-0">Total Salary Payment</td>
                            <td class="p-5 pt-0 pb-0 text-right">{{money($salary_pay)}}</td>
                        </tr>
                        <tr>
                            <td class="p-5 pt-0 pb-0">Other Income</td>
                            <td class="p-5 pt-0 pb-0 text-right">{{money($all_income)}}</td>
                            <td class="p-5 pt-0 pb-0"></td>
                            <td class="p-5 pt-0 pb-0">Other Expanse</td>
                            <td class="p-5 pt-0 pb-0 text-right">{{money($all_expance)}}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            <th class="p-5 pt-0 pb-0">Total Income</th>
                            <th class="p-5 pt-0 pb-0 text-right">{{money($bill_collection+$all_income)}}</th>
                            <th class="p-5 pt-0 pb-0"></th>
                            <th class="p-5 pt-0 pb-0">Total Expanse</th>
                            <th class="p-5 pt-0 pb-0 text-right">{{money($salary_pay+$all_expance)}}</th>
                        </tr>
                        <tr>
                            <th colspan="5" class="p-5 pt-0 pb-0 text-center text-indigo text-size-large">Total profit: {{money(($bill_collection+$all_income)-($salary_pay+$all_expance))}}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
