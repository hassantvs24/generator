...
@section('content')
    ...
    <div class="bg-white border-radius p-5">
        ...
        <div class="row">
            <div class="col-xs-12"><h5 class="text-center no-margin">Customer Ledger</h5></div>
        </div>
        <div class="row">
            <div class="col-xs-6"><b class="no-margin">Date: </b>{{$date_rang}}</div>
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    @foreach($table as $row)
                        ...
                        <tr>
                            ...
                            <td class="p-5 pt-0 pb-0 ">{{$row->customer['name'] or ''}} [{{$row->customer['contact'] or ''}}]</td>
