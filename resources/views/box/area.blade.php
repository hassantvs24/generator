        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><i class="icon-file-plus"></i> Add New Area</h5>
                </div>

                <form action="{{action('AreaController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h5 class="modal-title"><i class="icon-pencil7"></i> Edit Area</h5>
                </div>

                <form action="{{action('AreaController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
