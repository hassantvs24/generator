        ...
        <div class="modal-dialog modal-full">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><i class="icon-file-plus"></i> Add New Customer</h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control area_select" name="areaID">
                                            @foreach($area as $row)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control category_select" name="customerCatID">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="primaryPhoto" id="inputFile" placeholder="Customer Photo" type="file" accept="image/*">
                                    </div>
                                </div><br>
                                <div class="text-center">
                                    <img class="img-thumbnail preview" src="{{asset('public/no_img.jpg')}}" style="height: 150px;" alt="Customer Photo">
                                </div>
