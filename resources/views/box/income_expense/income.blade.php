        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><i class="icon-file-plus"></i> New Income</h5>
                </div>

                <form action="{{action('Income\IncomeController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="amountIN" placeholder="Income Amount" type="number" min="0" step="any" required>
                            </div>
                        </div><br>
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h5 class="modal-title"><i class="icon-pencil7"></i> Edit Income</h5>
                </div>

                <form action="{{action('Income\IncomeController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
