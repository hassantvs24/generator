...
class CreateBillMonthTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bill_month', function (Blueprint $table) {
            $table->increments('billMonthID');
    ...
    {
        Schema::dropIfExists('bill_month');
    }
}
